...
DoctorsSpecialzationResponse _$DoctorsSpecialzationResponseFromJson(
...
Map<String, dynamic> _$DoctorsSpecialzationResponseToJson(
        DoctorsSpecialzationResponse instance) =>
    <String, dynamic>{
